...
def standardize(img):
    ...
    img = img.resize([200,200],Image.ANTIALIAS) # Might want to change it up to 128 in future
    # plt.imshow(img)
...
def load_train_id_cards():
    X_train = np.empty((482,200,200,3), dtype="int32")
...
def load_train_slides():
    X_train = np.empty((316,200,200,3), dtype="int32")
...
def load_train_paper_documents():
    X_train = np.empty((306,200,200,3), dtype="int32")
...
def load_train_receipts():
    X_train = np.empty((300,200,200,3), dtype="int32")
...
def load_test_id_cards():
    X_test = np.empty((24,200,200,3), dtype="int32")
...
def load_test_slides():
    X_test = np.empty((10,200,200,3), dtype="int32")
...
def load_test_paper_documents():
    X_test = np.empty((14,200,200,3), dtype="int32")
...
def load_test_receipts():
    X_test = np.empty((17,200,200,3), dtype="int32")
